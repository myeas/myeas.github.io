<template>
<!--本组可以调用指定单个标签或分类的文章，可适用于任一页面，本组件为1行3列形式-->
<!-- 
  参考样式：
  1、调用分类文章，如下：
...
-->
  <div class="CategorTagUpdate-article-list3">
    <!-- <div class="CategorTagUpdate-article-title3">
      <router-link :to="moreArticle || '/archives/'" class="iconfont icon-bi"
        >最近更新</router-link
      >
    </div> -->
    <div class="CategorTagUpdate-article-wrapper3">
  ...
  .CategorTagUpdate-article-title3
    ...
    a
      ...
      &:before
        margin-right 0.4rem
        font-size 1.1rem
  .CategorTagUpdate-article-wrapper3
