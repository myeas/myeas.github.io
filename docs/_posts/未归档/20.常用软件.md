...
- name: Everything
  ...
  link: https://www.voidtools.com/Everything-1.4.1.1022.x64.zip
  bgColor: '#FFB6C1'
  textColor: '#621529'  
  
- name: WPS
  desc: 国产办公软件，文字、表格、演示、模板
  avatar: /easpublic/soft/WPS Office.png
  link: https://official-package.wpscdn.cn/wps/download/WPS_Setup_12763.exe
  bgColor: '#CBEAFA'
  textColor: '#6854A1'
  
- name: Beyond Compare
  desc: 文本文件对比软件，快速找出文件不同之外
  avatar: /easpublic/soft/BCompare.png
  link: https://www.scootersoftware.com/BCompare-zh-4.4.4.27058.exe
  bgColor: '#B9D59C'
  textColor: '#3B551F'
