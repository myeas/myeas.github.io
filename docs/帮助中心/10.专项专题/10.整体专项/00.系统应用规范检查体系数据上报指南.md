...
>
> 在此背景下，为督导和促进门店把金蝶系统应用质量提升专项工作转入日常管理工作，现要求各门店`定期（财务结账后，一般是每月7日左右）`，参考本文档操作指引，自行查询各指标数据，并填列到指定的单据上（`外部数据登记单`），此填列数据会形成系统日常管理报表（具体报表名称和路径待后续补充），加强日常对各指标数据的自查自纠、提升改善。  
>
> <br>
>
> **特别提醒**：
...
- **路径**：【业务报表】-【系统应用检查】-【系统应用检查】-【日清日结检查表（按日期创建）】
...
- **操作步骤**：双击末级路径，**期间**选择2023年3期，**科目**勾选`按科目对账`，**科目**选择代码的为`2203`明细科目、`2204`明细科目（不含2204.01预存款开票/2204.10待转销项税），往来类型选择`供应商`，币别为`人民币`，勾选`显示往来户明细`、`包括未过账凭证`、`只显示不平的记录`。建议保存为方案，这样以后只需要重选期间，其他条件都已保存好。
...
- **路径**：
  ...
  2.整车应付单：【财务会计】-【应付管理】-【应付业务处理】-【应付单维护】 
...
- **路径**：【业务报表】-【整车报表】-【新车销售】-【整车销售订单明细表（未收款）】
...
- **路径**：【业务报表】-【增值报表】-【代办服务】-【代办服务单明细表（未收款）】
...
- **路径**：【业务报表】-【精品配件】-【采购报表】-【精品配件采购入库超期未核销统计表（全部）】
...
- **路径**：【业务报表】-【精品配件】-【销售报表】-【精品配件销售明细表（未结算或未收款）】
...
- **路径**：【业务报表】-【维修报表】-【日常业务】-【维修明细表（未收款或未开票）】
...
- **路径**：【业务报表】-【系统应用检查】-【系统应用检查】-【系统应用检查之客户档案（门店）】
...
- **路径**：【业务报表】-【系统应用检查】-【系统应用检查】-【系统应用检查之车辆档案】
...
- **路径**：【业务报表】-【系统应用检查】-【系统应用检查】-【系统应用检查之维修工单】（工作表页签：送修电话重复）
...
- **路径**：【业务报表】-【系统应用检查】-【系统应用检查】-【系统应用检查之业务制单不同】
...
- **路径**：【业务报表】-【系统应用检查】-【系统应用检查-系统应用检查之维修工单】（工作表页签：业务流程）
...
- **指标**：
  ...
  - 填写说明：
    ...
    点击**前台收款单查询**，统计统计源单类型为空的前台收款单的单据总数，即为手工前台收款单数；
